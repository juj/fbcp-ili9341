...
// core_freq=258: CDIV=8, results in 32.25MHz
...
// core_freq=260: CDIV=8, would result in 32.50MHz, this would work 99% of the time, but full screen fade-ins and fade-outs would start to exhibit occasional incorrect pixel noise
