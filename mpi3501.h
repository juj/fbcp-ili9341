...
#define DISPLAY_NO_OPERATION 0x00001100
#define DISPLAY_SLPIN        0x10001100
#define DISPLAY_SLPOUT       0x11001100
#define DISPLAY_ON           0x29001100
#define DISPLAY_OFF          0x28001100
#define DISPLAY_SET_CURSOR_X 0x2A001100
#define DISPLAY_SET_CURSOR_Y 0x2B001100
#define DISPLAY_WRITE_PIXELS 0x2C001100
#define DISPLAY_SETOSC       0xB0001100
#define DISPLAY_SETRGB       0xB3001100
#define DISPLAY_SETEXTC      0xB9001100
#define DISPLAY_SETSTBA      0xC0001100
#define DISPLAY_SETDGC       0xC1001100
#define DISPLAY_SETDDB       0xC4001100
#define DISPLAY_TEON         0x35001100
#define DISPLAY_MADCTL       0x36001100
#define DISPLAY_IDMOFF       0x38001100
#define DISPLAY_IDMON        0x39001100
#define DSPLAY_COLMOD        0x3A001100
#define DISPLAY_TESL         0x44001100
#define DISPLAY_WRDISBV      0x51001100
#define DISPLAY_WRCTRLD      0x53001100
#define DISPLAY_WRCABC       0x55001100
#define DISPLAY_GETICID      0xD0001100
#define DISPLAY_GETSPIREAD   0xff001100
